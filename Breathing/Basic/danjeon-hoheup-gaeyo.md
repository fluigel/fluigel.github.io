...
생명에너지의 밀도가 높아지면 강렬한 에너지 현상을 느끼게 된다. 이윽고 완연히 생명에너지인 단(丹)을 형성하면, 그 이후로는 더 큰 난관은 없다.

자신의 생명에너지와 우주의 생명에너지가 하나되는 대주천(大周天) 현상이 발생하거나, 인체의 '기공(氣孔)'을 통해 체외로 분출된 생명에너지가 우주의 생명에너지와 연결되는 ‘기공호흡(氣孔呼吸)’ 현상 등 여러가지 놀랍고 신선한 체험이 이어질 것이다.
...
이렇게 단전호흡으로 축적되는 생명에너지는 신(神)의 선물임과 동시에 인간 존재의 본질을 깨닫게 하는 작용체이며, 삶에 활력을 주고 기쁨을 알게 해주어 현실을 살아가는 여러분들에게 필설로 다하지 못할 든든한 조력자가 되어줄 것을 마다하지 않을 것이다.
