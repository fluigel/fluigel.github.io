...
이는 실내에서 수련 중일 경우, ‘쿵’ 하는 소음과 함께 바닥에 내려앉는 일이 반복되기도 하여, 주변에 함께 수련하는 이들에게 놀라움과 당혹감을 줄 수 있다. 때로는 [※주의: 수련자의 몸체가 솟구쳤다가](gongjung-euro-sotguchineun-hyeonsang.html), 다른 수련자의 무릎 위에 떨어지는 등의 우발적인 상황도 발생할 수 있으므로, 이러한 점은 미리 인지하고 주의할 필요가 있다.
