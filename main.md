...
플뤼겔의 탑 (Fluegel’s Tower): 길잡이

이곳에서 다루는 모든 수행의 기준은 '팔정도(八正道)'입니다. 삶을 어떻게 살아야 하는가에 대한 가장 근본적인 길, 그것이 정법(正法)입니다.

이 사이트는 특정한 체험이나 능력을 얻기 위한 곳이 아닙니다. 삶 그 자체를 수행의 자리로 되돌리고, 인간이 흔들리지 않고 살아가기 위한 '중도(中道)'라는 기준을 분명히 하기 위해 존재합니다.
...
천 년 전에도, 만 년 전에도 물은 위에서 아래로 흐릅니다. 이는 변하지 않는 자연의 법칙이며, 팔정도 역시 그러한 진리의 한 모습입니다. 시대와 문화가 달라져도 정법은 언제나 같은 방향을 가리킵니다.
...
이것은 신단으로 인해 이미 백회의 문이 한 번 열리며 남게 되는 보이지 않는 흔적으로 이해하시면 됩니다.
...
신단과 팔정도는 본질적으로 동일한 수행입니다. 첫 번째는 의식(意識)의 기능으로 생명에너지를 축적하는 것으로, 신단 용어를 마음으로 외치거나 '반성명상(反省瞑想)'이 이에 해당하겠지요.
