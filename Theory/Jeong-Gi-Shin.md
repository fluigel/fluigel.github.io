...
신(神)은 인간의 표면의식이 활동하는 자리로 보이며, 여기까지 생명에너지가 축적되면 우주와 연결되는 하나의 교차점이기도 하다. 또한 마음의 거울처럼 작용하는 자리이며, 오관(五官)을 통해 들어온 정보가 이곳에 모여 통합되고, 인체 각 기관으로 지령을 전달하는 두뇌 부위와 밀접한 관련이 있다.
